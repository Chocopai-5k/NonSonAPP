import { ScrollView, Text, View,Box,Image, Heading, HStack, Spacer} from "native-base";
            ...
            <ScrollView px={2} showsVerticalScrollIndicator={false}>
                ...
                <HStack space={2} alignItems="center" my={5}> 
                    {product.countInStock>0 ? (
                      ...
                      />
                    ):<Heading bold color={Colors.red} italic fontSize={10}>Out of stock</Heading>}
                  
                    <Spacer/>           
                    <Heading bold color={Colors.black} fontSize={19}>${product.price}</Heading>
                </HStack>       
                <Text lineHeight={24} fontSize={12}>
                    {product.descrieption}
                </Text>         
